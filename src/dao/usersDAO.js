  ...
  */
  ...
  static async addUser(userInfo) {
    ...
    */
    ...
    try {
      ...
      return {success : insertResult.result}
    } catch (e) {
  ...
  static async loginUser(email, jwt) {
    try {
      ...
      const sessionResponse = await sessions.updateOne(
        { user_id: email },
        { $set: { jwt: jwt } },
        { upsert: true}
      )
      ...
      return { success: sessionResponse.result }
    } catch (e) {
  ...
  static async logoutUser(email) {
    try {
      ...
      const deleteResult = await sessions.deleteOne({ user_id: email })
      return { success: deleteResult.result}
    } catch (e) {
  ...
  static async deleteUser(email) {
    try {
      const userDeleteResponse = await users.deleteOne({ email: email })
      const sessionDeleteResoponse = await sessions.deleteOne({ user_id: email })
