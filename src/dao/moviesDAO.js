...
export default class MoviesDAO {
    ...
    static async getMovies({
        ...
        */
        ...
        let skipValue = parseInt(moviesPerPage * page)

        const displayCursor = cursor.skip(skipValue).limit(moviesPerPage)

        try {
            let moviesList = await displayCursor.toArray()
    ...
    static async getMovieByID(id) {
        try {
            ...
            */
            ...
            const errorString = 'Error: Argument passed in must be a single String of 12 bytes or a string of 24 hex characters'
            console.log('Logging the error name : ' , e.toString() , 'and if it matches errorString' , errorString == e.toString())
